...
var Spinner = function (_a) {
    ...
    return (React.createElement(Container$3, null,
        React.createElement(PulseLogoIcon, { width: "".concat(size * 0.5, "px") })));
};
    ...
    return (React.createElement(Container, null,
        React.createElement(SocialEntry, null,
            cakePriceUsd ? (React.createElement(PriceLink, { href: cakePriceLink, target: "_blank" },
                ...
                React.createElement(Text, { color: "text", fontSize: "15px", bold: true }, "$".concat(cakePriceUsd.toFixed(3))))) : (React.createElement(Skeleton, { width: 80, height: 24 })),
