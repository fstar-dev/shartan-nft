								...
								<Modal.Body className="dashboard-modal-body">
										...
										<div className="text-center my-3">
												<svg xmlns="http://www.w3.org/2000/svg" width="130" height="130" viewBox="0 0 130 130">
													<g id="Ellipse_1" data-name="Ellipse 1" fill="#fff" stroke="#707070" strokeWidth="1" opacity="0.15">
														<circle cx="65" cy="65" r="65" stroke="none"/>
														<circle cx="65" cy="65" r="64.5" fill="none"/>
													</g>
													<g id="ETH" transform="translate(32 19)">
														<path id="Path_10" data-name="Path 10" d="M32.013,62.126V0L2.254,51.1Zm0,0" transform="translate(-1.849)" fill="#4e0000"/>
														<path id="Path_11" data-name="Path 11" d="M197.887,326.751v24.122l30.164-35.295Zm0,0" transform="translate(-162.329 -258.873)" fill="#4e0000"/>
														<path id="Path_12" data-name="Path 12" d="M197.887,0V62.126L227.646,51.1Zm0,0" transform="translate(-162.329)" fill="#4e0000"/>
														<path id="Path_13" data-name="Path 13" d="M30.164,326.751,0,315.578l30.164,35.295Zm0,0" transform="translate(0 -258.873)" fill="#4e0000"/>
													</g>
												</svg>
										</div>
